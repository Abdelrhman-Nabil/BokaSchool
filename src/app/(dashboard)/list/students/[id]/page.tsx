  ...
  <div className="flex-1 flex gap-4 justify-between flex-wrap">
    ...
    <div className="bg-white p-4 rounded-md ">
        ...
        <Link className="p-3 rounded-md bg-[#EDF9FD]"
         href={`/list/lessons?classId=${2}`}>Student's  Lessons</Link>
        <Link className="p-3 rounded-md bg-[#F1F0FF]"
         href={`/list/teachers?classId=${2}`}>Student's  Teachers</Link>
        <Link className="p-3 rounded-md bg-pink-50"
         href={`/list/exams?classId=${2}`}>Student's  Exams</Link>
        <Link className="p-3 rounded-md bg-[#EDF9FD]"
         href={`/list/assignments?classId=${2}`}>Student's  Assignments</Link>
        <Link className="p-3 rounded-md bg-[#EDF9FD]"
         href={`/list/results?studentId=${2}`}>Student's  Result</Link>
